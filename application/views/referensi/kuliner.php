    ...
    <div class="col-sm-8">
      <div class="row">
        <?php foreach ($kuliner as $k) : ?>
          <div class="col-lg-6">
            <div class="column">
              <img src="<?= base_url('assets/img/wisata/') .  $k->image; ?>"style="width:100%">
              <div class="bottom-right"><?= $k->sumber; ?></div>
              <div class="container">
                <h2><?= $k->name; ?></h2>
                <a class="btn btn-danger text-right" style="margin-left:25%" href="<?= base_url('referensi/detail_wisata/').$k->id; ?>">Selengkapnya</a>
              </div>
            </div>
          </div>
        <?php endforeach; ?>
