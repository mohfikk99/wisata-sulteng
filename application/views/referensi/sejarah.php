    ...
    <div class="col-sm-8">
      <div class="row">
        <?php foreach ($sejarah as $s) : ?>
          <div class="col-lg-6">
            <div class="column">
              <img src="<?= base_url('assets/img/wisata/') .  $s->image; ?>"style="width:100%">
              <div class="bottom-right"><?= $s->sumber; ?></div>
              <div class="container">
                <h2><?= $s->name; ?></h2>
                <a class="btn btn-danger text-right" style="margin-left:25%" href="<?= base_url('referensi/detail_wisata/').$s->id; ?>">Selengkapnya</a>
              </div>
            </div>
          </div>
        <?php endforeach; ?>
