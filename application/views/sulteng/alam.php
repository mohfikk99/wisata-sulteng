    ...
    <div class="col-sm-8">
      <div class="row">
        <?php foreach ($alam as $a) : ?>
          <div class="col-lg-6">
            <div class="column">
              <img src="<?= base_url('assets/img/wisata/') .  $a->image; ?>" id="myImg" style="width:100%;">
              <div class="bottom-right" style="color:white; font-size:12px; font-style:italic;"><?= $a->sumber; ?></div>
              <div class="container">
              <h4><?= $a->name; ?></h4>
              <a class="btn btn-danger text-right" style="margin-left:25%" href="<?= base_url('sulteng/detail_wisata/').$a->id; ?>">Selengkapnya</a>
              </div>
            </div>
          </div>
        <?php endforeach; ?>
