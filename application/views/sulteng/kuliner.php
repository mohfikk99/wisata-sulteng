<!--jimbotron  -->
<div class="jumbotron jumbotron-fluid text-center" style="background-image: url(../assets/img/tampilan/kuliner.jpg);">
    ...
    <div class="col-sm-8">
      <div class="row">
        <?php foreach ($kuliner as $k) : ?>
          <div class="col-lg-6">
            <div class="column">
              <img src="<?= base_url('assets/img/wisata/') .  $k->image; ?>" id="myImg" style="width:100%;">
              <div class="bottom-right" style="color:white; font-size:12px; font-style:italic;"><?= $k->sumber; ?></div>
              <div class="container">
              <h4><?= $k->name; ?></h4>
              <a class="btn btn-danger text-right" style="margin-left:25%" href="<?= base_url('sulteng/detail_wisata/').$k->id; ?>">Selengkapnya</a>
              </div>
            </div>
          </div>
        <?php endforeach; ?>
