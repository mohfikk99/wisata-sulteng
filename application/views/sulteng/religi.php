<!--jimbotron  -->
<div class="jumbotron jumbotron-fluid text-center" style="background-image: url(../assets/img/tampilan/religi.jpg);">
...
<div class="container">
  ...
  <div class="row">
    <div class="col-sm-8">
      <div class="row">
        <?php foreach ($religi as $r) : ?>
          <div class="col-lg-6">
            <div class="column">
              <img src="<?= base_url('assets/img/wisata/') .  $r->image; ?>" id="myImg" style="width:100%;">
                <div class="bottom-right" style="color:white; font-size:12px; font-style:italic;"><?= $r->sumber; ?></div>
              <div class="container">
              <h4><?= $r->name; ?></h4>
              <a class="btn btn-danger text-right" style="margin-left:25%" href="<?= base_url('sulteng/detail_wisata/').$r->id; ?>">Selengkapnya</a>
              </div>
            </div>
          </div>
        <?php endforeach; ?>
    ...
    <div class="col-sm-3">
      <div class="form-container o-hidden border-5 shadow-lg my-10">
        <h1>Terbaru</h1>
        <hr>
        <img src="<?= base_url('assets/img/wisata/') .  $terbaru->image; ?>" width="250" class="image">
        <div class="overlay"><?= $terbaru->name; ?></div>
      </div>
      <div class="form-container o-hidden border-5 shadow-lg my-10">
        <h1>Event</h1>
        <hr>
        <img src="<?= base_url('assets/img/wisata/') .  $populer->image; ?>" width="250" class="image">
