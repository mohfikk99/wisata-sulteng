<!--jimbotron  -->
<div class="jumbotron jumbotron-fluid text-center" style="background-image: url(../assets/img/tampilan/sejarah.jpg);">
    ...
    <div class="col-sm-8">
      <div class="row">
        <?php foreach ($sejarah as $s) : ?>
          <div class="col-lg-6">
            <div class="column">
              <img src="<?= base_url('assets/img/wisata/') .  $s->image; ?>" id="myImg" style="width:100%;">
                <div class="bottom-right" style="color:white; font-size:12px; font-style:italic;"><?= $s->sumber; ?></div>
              <div class="container">
              <h4><?= $s->name; ?></h4>
              <a class="btn btn-danger text-right" style="margin-left:25%" href="<?= base_url('sulteng/detail_wisata/').$s->id; ?>">Selengkapnya</a>
              </div>
            </div>
          </div>
        <?php endforeach; ?>
