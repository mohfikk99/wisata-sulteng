<!--jimbotron  -->
<div class="jumbotron jumbotron-fluid text-center" style="background-image: url(../assets/img/tampilan/danau.jpg);">
          ...
          <div class="container mt-5 mb-5" style="background-color:#990900; width:100%; border-radius:10px;">
                <div class="row">
                    ...
                    <table>
                      <tr>
                        <td>
                          <p class="text-center mt-3">SULAWESI TENGAH berada di kawasan Indonesia timur, yang menyimpan keindahan tersembunyi di garis Khatulistiwa. <br>
                        ...
                        <p><b>Developer : wisatasulteng.com</b></p>
                        <p><b>Alamat    : Kota Palu, Sulawesi Tengah</b></p>
